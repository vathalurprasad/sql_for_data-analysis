...
CREATE TABLE `brands` (
  ...
  `made_off` varchar(50) DEFAULT NULL,
  `address` char(50) DEFAULT NULL,
  `actuall_price` int DEFAULT NULL,
  KEY `idx_customer_name` (`customer_name`),
  KEY `idx_brand_name` (`brand_name`),
  KEY `idx_made_off` (`made_off`),
  KEY `idx_actuall_price` (`actuall_price`)
...
INSERT INTO `brands` VALUES ('ramesh','sg','meerut','india',15000),('kishore','wilson','chicago','usa',6000),('narendra','cosco','delhi','india',7500),('suresh','nivia','jalandhar','india',10000),('mahesh','yonex','tokyo','japan',20000);
...
-- Dump completed on 2025-04-24 23:12:02
